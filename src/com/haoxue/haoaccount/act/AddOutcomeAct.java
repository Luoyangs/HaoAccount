...
public class AddOutcomeAct extends FragmentActivity implements OnClickListener{
	...
	private void initTo(View view) {
		String[] srcs = getResources().getStringArray(R.array.outcome_use);
        ...
        lv.setAdapter(new ListViewAdapter(AddOutcomeAct.this, list));
	...
	private void initSrc(View view){
		String[] srcs = getResources().getStringArray(R.array.outcome_from);
		final List<String> list = Arrays.asList(srcs);
		//通过布局注入器，注入布局给View对象
        View myView = getLayoutInflater().inflate(R.layout.pop_layout, null);
        //通过view 和宽·高，构造PopopWindow
	...
	private void initType(View view){
        ...
        plv.setAdapter(new ListViewAdapter2(AddOutcomeAct.this, plist));
        plv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                clv.setAdapter(new ListViewAdapter2(AddOutcomeAct.this, clist));
