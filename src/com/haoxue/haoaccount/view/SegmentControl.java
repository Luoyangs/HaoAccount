...
public class SegmentControl extends RadioGroup {
    ...
    private class LayoutSelector {
        ...
        private int getChildren() {
            return SegmentControl.this.getChildCount();
        }

        private int getChildIndex(View view) {
            return SegmentControl.this.indexOfChild(view);
        }
