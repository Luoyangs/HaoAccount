...
package com.haoxue.haoaccount.view.wheel;
...
public class WheelView extends View {
	...
	private static final int ADDITIONAL_ITEM_HEIGHT = 16;

	/** Text size */
	private static final int TEXT_SIZE = 52;
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xff0000);
		}
